    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>HamroCollection</strong></h2>

            </td>
            <td align="right">
                <pre class="font">
               HamroCollection Head Office
               Email:support@hamrocollection.com <br>
               Mob: 1234567890 <br>
               Kathmandu,Nepal <br>
        ...
        <tr>
            <td>
                <p class="font" style="margin-left: 20px;">
                    ...
                    $munic = $order->municipal->municipal_name;
                    $gau = $order->notes;
                    @endphp

                    <strong>Address:</strong> {{ $prov }},{{ $dist }}, {{ $munic }} <br>
