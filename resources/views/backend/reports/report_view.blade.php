    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-4">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Searc By Months </h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="table-responsive">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select name="month" class="form-control" id="">
                                            <option value="Choose One" selected="" disabled="">Choose Month</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select name="year_name" class="form-control" id="">
                                            <option value="Choose One" selected="" disabled="">Choose Year</option>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            ...
                            <form action="{{ route('report-by-year') }}" method="post" enctype="multipart/form-data">
                                @csrf
