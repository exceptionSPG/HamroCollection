                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="category_id" class="form-control" required="">
                                                        ...
                                                        <option value="{{ $item->id }}" {{ ( $item->id == $post->category_id )?'seleceted':''}}>{{ $item->blog_category_name_en }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="post_title_en" value="{{ $post->post_title_en}}" class="form-control" required="">
                                                    @error('post_title_en')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="{{ $post->post_title_nep}}" name="post_title_nep" class="form-control">
