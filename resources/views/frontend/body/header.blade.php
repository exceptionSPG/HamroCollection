                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                <li class="active dropdown yamm-fw"> <a href="{{ url('/') }}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">@if(session()->get('language') == 'nepali')गृहपृष्ठ @else Home @endif</a> </li>
                                <!-- GET Category Data -->
                                @php
                                ...
                                <li class="dropdown yamm mega-menu"> <a href="" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">@if(session()->get('language') == 'nepali'){{ $category->category_name_nep }} @else {{ $category->category_name_en }} @endif</a>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                                                        ...
                                                        <ul class="links">
                                                            ...
                                                            <li><a href="#">@if(session()->get('language') == 'nepali'){{ $subsubcat->sub_subcategory_name_nep }} @else {{ $subsubcat->sub_subcategory_name_en }} @endif </a></li>
                                                            @endforeach
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image"> <img class="img-responsive" src="{{ asset('frontend/assets/images/banners/top-menu-banner.jpg') }}" alt="">
                                                    </div>
                                                    <!-- /.yamm-content -->
